...
import { ApiConfig, ModelConfig, Crud } from '../src/interfaces/types';
import { COMMON_FILES, DIRECTORIES, EXTENSIONS, OUTPUT_DIR } from '../src/utils/constants';
import { crudGenerator } from '../src/modules/crudGenerator';
...
// Model resources generator module
...
// it('should generate a CRUD', async () => {
//   await crudGenerator(modelConfig, OUTPUT_DIR)
// })
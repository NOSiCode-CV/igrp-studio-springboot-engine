...
export const relationSchema: JSONSchemaType<Relation> = {
  ...
  properties: {
    ...
    fieldName: {
      ...
      errorMessage:
        'The fieldName field, if provided, cannot contain spaces, hyphens, or special characters. Only alphanumeric characters are allowed.',
    },
    mappedBy: {
      type: 'string',
      nullable: true,
      ...
      errorMessage:
        'The mappedBy field, if provided, must be a valid string following the naming convention.',
    },
    referencedColumnName: {
      ...
      pattern: PATTERNS.RELATIONS_PATTERN,
      errorMessage:
        'The referencedColumnName field, if provided, must be a valid string following the naming convention.',
    },
    cardinality: {
      type: 'string',
      enum: ['oneWay', 'twoWay'],
    ...
    joinTable: {
      ...
      pattern: PATTERNS.RELATIONS_PATTERN,
      errorMessage:
        'The joinTable field, if provided, must be a valid string following the naming convention.',
    },
    inverseJoinColumn: {
      type: 'string',
      nullable: true,
      pattern: PATTERNS.RELATIONS_PATTERN,
      errorMessage:
        'The inverseJoinColumn field, if provided, must be a valid string following the naming convention.',
    },
    joinColumn: {
      type: 'string',
      nullable: true,
      pattern: PATTERNS.RELATIONS_PATTERN,
      errorMessage:
        'The joinColumn field, if provided, must be a valid string following the naming convention.',
    },
    module: {
      type: 'string',
      nullable: true,
...
const relationReferenceSchema: JSONSchemaType<RelationReference> = {
  ...
  properties: {
    ...
    fieldName: {
      ...
      pattern: PATTERNS.PARAMS_VALIDATION,
      errorMessage:
        'The fieldName field, cannot contain spaces, hyphens, or special characters. Only alphanumeric characters are allowed.',
    },
    joinColumn: {
      type: 'string',
      nullable: true,
      pattern: PATTERNS.PARAMS_VALIDATION,
      errorMessage:
        'The joinColumn field, cannot contain spaces, hyphens, or special characters. Only alphanumeric characters are allowed.',
    },
    mappedBy: {
      type: 'string',
      nullable: true,
...
const crudSchema: JSONSchemaType<Crud> = {
  ...
  properties: {
    ...
    path: {
      ...
      errorMessage:
        'The path must contain only alphabetic characters and cannot contain spaces or special characters.',
    },
    permissions: {
      type: 'array',
...
const uniqueConstraintSchema: JSONSchemaType<UniqueConstraint> = {
  ...
  properties: {
    ...
    columns: {
      ...
      items: {
        ...
        pattern: PATTERNS.NAME_VALIDATION_PATTERN,
        errorMessage:
          'Each column name in the unique constraint must follow the naming convention.',
      },
  ...
  errorMessage: {
    additionalProperties:
      'No additional properties are allowed in the unique constraint configuration schema.',
  },
};
...
const entityIndexSchema: JSONSchemaType<EntityIndex> = {
  ...
  errorMessage: {
    additionalProperties:
      'No additional properties are allowed in the entity index configuration schema.',
  },
};
...
const modelConfigSchema: JSONSchemaType<ModelConfig> = {
  ...
  properties: {
    ...
    tableName: {
      ...
      pattern: PATTERNS.NAME_VALIDATION_PATTERN,
      errorMessage:
        'The table name must follow the naming convention (only alphabetic characters allowed) and cannot be empty.',
    },
    primaryKey: {
      type: 'array',
      nullable: true,
    ...
    uniqueConstraints: {
      ...
      errorMessage:
        'The uniqueConstraints must be an array of valid unique constraint definitions.',
    },
    relationReference: {
      type: 'array',
      nullable: true,
      ...
      errorMessage:
        'The relation Reference must be an array of valid relation Reference definitions.',
    },
    indexes: {
      type: 'array',
      nullable: true,
    ...
    audit: {
      // Definition of the new audit field
      type: 'boolean',
      nullable: true,
...
export const validateModelConfig: ValidateFunction<ModelConfig> =
  ajvInstance.compile<ModelConfig>(modelConfigSchema);
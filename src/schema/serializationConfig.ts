...
const serializationSchema: JSONSchemaType<SerializationConfig> = {
  ...
  properties: {
    ...
    ddl: {
      ...
      nullable: true,
      errorMessage:
        'Invalid DDL create table script format. Valid format: CREATE TABLE table_name (...)',
    },
  },
...
export const serializationValidation: ValidateFunction<SerializationConfig> =
  ajvInstance.compile<SerializationConfig>(serializationSchema);
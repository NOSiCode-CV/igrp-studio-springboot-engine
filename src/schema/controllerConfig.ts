        ...
        permission: {
            ...
            properties: {
                items: {
                    ...
                    items: {type: 'string'},
                    minItems: 1,
                    errorMessage: "The 'permission.items' field must be a non-empty array of strings",
                },
                operator: {
                    type: 'string',
                    enum: ['AND', 'OR'],
                    nullable: true,
                    errorMessage: "The 'permission.operator' field must be 'AND' or 'OR' if provided",
                },
            },
            required: ['items'],
            additionalProperties: false,
            errorMessage:
                "The 'permission' field must be an object with 'items' (array of strings) and optional 'operator' ('AND' or 'OR').",
        },
        roles: {
            type: 'array',
            nullable: true,
        ...
        globalPermission: {
            ...
            properties: {
                items: {
                    ...
                    items: {type: 'string'},
                    minItems: 1,
                    errorMessage: "The 'globalPermission.items' field must be a non-empty array of strings",
                },
                operator: {
                    type: 'string',
                    enum: ['AND', 'OR'],
                    nullable: true,
                    errorMessage: "The 'globalPermission.operator' field must be 'AND' or 'OR' if provided",
                },
            },
            required: ['items'],
            additionalProperties: false,
            errorMessage:
                "The 'globalPermission' field must be an object with 'items' (array of strings) and optional 'operator' ('AND' or 'OR').",
        },
        globalRoles: {
            type: 'array',
            nullable: true,

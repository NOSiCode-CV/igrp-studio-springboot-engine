...
export const JAVA_TYPES: Map<string, TypeMetadata> = new Map(
  Object.entries({
...
export const GENERIC_DTO_ATTRIBUTE_TYPES = [...GENERIC_ATTRIBUTE_TYPES];

export const GENERIC_COLLECTION_TYPES = ['list', 'map', 'set'];
